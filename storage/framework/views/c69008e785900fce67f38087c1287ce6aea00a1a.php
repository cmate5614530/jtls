...
<script>
    function readURL(input) {
        if (input.files && input.files[0]) {
            ...
            $('#profile_photo').attr('src', "<?php echo e(asset('assets_admin/img/features/feature-01.jpg')); ?>");
        }
    }
...
<?php echo $__env->make('layouts.layout_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Laravel\Laravel_blade\bet\resources\views/admin/profile_admin.blade.php ENDPATH**/ ?>