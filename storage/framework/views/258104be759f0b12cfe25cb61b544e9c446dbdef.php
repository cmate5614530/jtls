<footer class="section footer-classic footer-classic-dark">
    <div class="footer-classic-main" style="display: none;">
        <div class="container">
            <div class="row">
                <!--  col 1 -->
    ...
    <div class="footer-classic-aside footer-classic-darken">
        <div class="container">
            <div class="layout-justify">
                ...
                <p class="rights">© Copyright 2021. All rights reserved.</p>
...
<?php /**PATH F:\Laravel\Laravel_blade\bet\resources\views/layouts/footer.blade.php ENDPATH**/ ?>