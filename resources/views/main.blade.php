                            ...
                            <?php if(sizeof($odds_basketball_nba)){
                                ...
                                <div class="sport-table-tr">
                                    <div class="row sport-row align-items-left row-15">
                                        ...
                                        <div class="col-sm-2 col-md-2 col-lg-2">
                                            <div class="twobox">
                                                <button class="place-link bet-button" data-wager-type="ML" data-team-name="<?php echo $item->team1;?>"
                                                ...
                                                ?>"><?php
                                                    ...
                                                    ?></button>
                                                <button class="place-link bet-button" data-wager-type="ML" data-team-name="<?php echo $item->team2;?>"
                                                        data-confrontation="<?php echo $item->team1.' vs '.$item->team2;?>" data-wager-count="<?php
                                                if(json_decode($item->h2h)){
                                        ...
                                        <div class="col-sm-2 col-md-2 col-lg-2">
                                            <div class="twobox">
                                                <button class="place-link bet-button" data-wager-type="RL" data-team-name="<?php echo $item->team1;?>"
                                                        data-confrontation="<?php echo $item->team1.' vs '.$item->team2;?>" data-wager-count="<?php
                                                ...
                                                ?>"><?php
                                                    ...
                                                    ?></button>
                                                <button class="place-link bet-button" data-wager-type="RL" data-team-name="<?php echo $item->team2;?>"
                                                        data-confrontation="<?php echo $item->team1.' vs '.$item->team2;?>" data-wager-count="<?php
                                                if(json_decode($item->spreads)){
                                        ...
                                        <div class="col-sm-2 col-md-2 col-lg-2">
                                            <div class="twobox">
                                                <button class="place-link bet-button" data-wager-type="TL" data-team-name="<?php echo $item->team1;?>"
                                                        data-confrontation="<?php echo $item->team1.' vs '.$item->team2;?>" data-wager-count="<?php
                                                ...
                                                ?>"><?php
                                                    ...
                                                    ?></button>
                                                <button class="place-link bet-button" data-wager-type="TL" data-team-name="<?php echo $item->team2;?>"
                                                        data-confrontation="<?php echo $item->team1.' vs '.$item->team2;?>" data-wager-count="<?php
                                                if(json_decode($item->totals)){
